...
$adventure_trekking_camp_post_args = array(
    'posts_per_page'    => '3',
    'orderby'           => 'rand',
...
$adventure_trekking_camp_ids = array();
foreach( $related as $term ) {
    $adventure_trekking_camp_ids[] = $term->term_id;
}

$adventure_trekking_camp_post_args['category__in'] = $adventure_trekking_camp_ids; 

$related_posts = new WP_Query( $adventure_trekking_camp_post_args );

if ( $related_posts->have_posts() ) : ?>
    <div id="Category-section" class="similar-post">
        <h3 class="text-center pb-3"><?php echo esc_html(get_theme_mod('adventure_trekking_camp_similar_text',__('Explore More','adventure-trekking-camp'))); ?></h3>
        <div class="row">

	...
	if($adventure_trekking_camp_header_option == 'on'){ ?>
		...
		<?php else : ?>
			<header class="page-header">
				...
				<?php } ?>
				<h2 class="page-title mt-4 text-center"><span><?php esc_html_e( 'Posts', 'adventure-trekking-camp' ); ?></span></h2>
				</div>
			</header>
		<?php endif; ?>
	<?php }
		...
		<?php else : ?>
			<header class="mt-4">
				...
				<?php } ?>
				<h2 class="page-title mt-4 withoutimg text-center"><span><?php esc_html_e( 'Posts', 'adventure-trekking-camp' ); ?></span></h2>
			</header>
		<?php endif; ?>
	<?php } ?>	
	<div class="container">
